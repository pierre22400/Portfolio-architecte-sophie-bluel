...
// --------------------------------------------------------------------
// login.html contient la structure du formulaire.
// login.js récupère ce formulaire pour lui associer le comportement.
//
// querySelector("#login-form") -> cherche dans le DOM l'élément ayant l'id login-form.
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
// on écoute l'événement "submit", pas uniquement un clic sur le bouton.
//
// Avantage :
// le formulaire fonctionne aussi si l'utilisateur valide avec Entrée.
//
// preventDefault() empêche le comportement HTML traditionnel, c'est-à-dire l'envoi/rechargement immédiat de la page.
...
form.addEventListener("submit", async function (event) {
  ...
  // 2E — POST LOGIN
  // ==============================================================
  // On ne récupère pas des données avec GET.
